...
function Write-JsonFile {
  ...
  [System.IO.File]::WriteAllText($Path, ((ConvertTo-AsciiSafeJsonText -Value $Value -Depth 10) + [Environment]::NewLine), $Utf8NoBom)
}
...
Write-Host ("Computer loop proof summary: desktop={0}, chrome={1}, phone={2}, parity={3}, web={4}, source={5}, externalMode={6}, text={7}/{8}/{9}+{10}/{11}/{12}, screenshots={13}+{14}, phoneEvidence={15}, devEnvEvidence={16}, webReadinessEvidence={17}, summary={18}" -f (Format-ProofStatus $ProofSummary.loops.desktop.success), (Format-ProofStatus $ProofSummary.loops.windowsChrome.success), (Format-LoopRunStatus $ProofSummary.loops.phone), (Format-ProofStatus $ProofSummary.browserParity.success), $ProofSummary.webReadiness.strategy, (Format-SourceState $SourceState), $ProofSummary.loops.desktop.externalExecutionSourceMode, $ProofSummary.loops.desktop.textRequiredPhrases, $ProofSummary.loops.desktop.textMissingPhrases, $ProofSummary.loops.desktop.textMojibake, $ProofSummary.loops.windowsChrome.textRequiredPhrases, $ProofSummary.loops.windowsChrome.textMissingPhrases, $ProofSummary.loops.windowsChrome.textMojibake, $ProofSummary.loops.desktop.screenshotCount, $ProofSummary.loops.windowsChrome.screenshotCount, $ProofSummary.evidence.phoneEvidencePath, $ProofSummary.evidence.devEnvEvidencePath, $ProofSummary.evidence.webReadinessEvidencePath, $ProofSummary.evidence.summaryPath)
