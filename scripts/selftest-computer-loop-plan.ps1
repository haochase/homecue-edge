...
function Assert-ComputerLoopPlanManifest {
  ...
  Assert-ObjectKeys $Plan.gates @("fullLoopIncludeChrome", "fullLoopIncludePhone", "fullLoopSkipPhone", "browserEvidenceRequireDesktop", "browserEvidenceRequireChrome", "browserEvidenceRequirePhone", "browserEvidenceSelfTest", "browserWrapperSharedStateLock", "fullLoopWebReadiness") "$Message gates fields"
...
try {
  ...
  Assert-True $Default.gates.fullLoopSkipPhone "Full-loop command should explicitly skip phone for computer-only checks."
  ...
  Assert-Contains $Default.commands.fullLoop.display "-SkipPhone" "Full-loop display command"
